...
int main() {
    ...
    do {
        ...
        // Verificar se as dimensões do tabuleiro foram definidas
        if (qtd_linhas > 0 && qtd_colunas > 0) {
            // Escolher o jogador inicial aleatoriamente
            srand(time(0)); // Inicializa o gerador de números aleatórios
            jogador_atual = (rand() % 2) + 1; // Retorna 1 ou 2
